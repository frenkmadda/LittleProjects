	   ...
	   printf("4)Run away\n");
	    ...
	    switch(choise) {
                        ...
                        case 2: { printf("You receive a defense boost!");
                                  ...
                                  def+=20;								break; //aumento difesa per questo turno
					         	} 								  
	                              ...
	                              printf("2)Book of info\n");						
								   ...
								   scanf("%d", &choise);
                                    ...
                                    switch(choise) {
                                                     ...
                                                     case 2: { printf("You're facing SDADHEDE a Boss of the underground world: ATK 80 - DEF 43 \n\n");                                                          
															   printf("\a");															   //suono campanella
															   sleep(1);
															   printf("\a");
															   printf("\a");
